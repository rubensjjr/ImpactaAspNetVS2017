...
namespace AspNetVS2017.Capitulo02.Http.Testes
{
    ...
    public class HttpTeste
    {
        ...
        {
            var request = (HttpWebRequest)WebRequest.Create("http://www.example.com?usuarioId=42&cpf=123456");

            request.Method = "GET";
            request.UserAgent = "Visual Studio";
            request.Date = DateTime.Now;
            request.Headers.Add("Authorization", "ushkdhjkfhsfhusdfhuidhuisdfhuisfdh");
        ...
        public void RequestPostTeste()
        {
            ...
            var dados = "nome=Vitor&cpf=2354654&endereco=R.tal";
